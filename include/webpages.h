...
<body>
  <p>File Upload Utility</p>
  <p>Firmware: %FIRMWARE%</p>
  <p>Free Storage: <span id="freespiffs">%FREESD%</span> | Used Storage: <span id="usedspiffs">%USEDSD%</span> | Total Storage: <span id="totalspiffs">%TOTALSD%</span></p>
  <p>
